...
<h1 align="center">Blazersnake Bot  <br>
	<a href="https://discord.com/oauth2/authorize?client_id=1222021162641522700&permissions=8&scope=bot+applications.commands"><img src="https://img.shields.io/badge/Blazersnake_Bot-Invite_Bot-blue" alt="Patreon"></a>
...
<p>Welcome to Blazersnake Bot Support wiki, Thanks for using our Bot, as well the idea of this bot is to create a easy way to get our Models, works, Projects, ...etc, And not only this bot includes Configurable bot w/ welcome images, logs, social commands, moderation, self-assignable role, social media notifications & server protection..</p>
<p>Add/invite the bot to your server, and try it now!</p>
<p>&nbsp;</p>
